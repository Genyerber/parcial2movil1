...
export default {
  ...
  async created() {
    ...
    const pagina = 18; // Ajusta la página según tus necesidades
    const url = `https://api.themoviedb.org/3/movie/now_playing?page=${pagina}&api_key=${apiKey}&language=es-CO`;
